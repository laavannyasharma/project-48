...
backgroundSound = loadSound("background music.mp3")
...
function draw(){
 ...
 sparkle.x=sparkle.x+2
  ...
  if(Princess.isTouching(snailGroup)||Princess.isTouching(turtleGroup)||Princess.isTouching(dragonGroup)||Princess.isTouching(tower)){
    gamestate = end
    gameoverSound.play()
